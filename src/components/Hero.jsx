      ...
      {/* Left side content */}
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-center lg:items-start lg:pl-16'>
            ...
            <div className='px-2'> 
            <a href='https://drive.google.com/file/d/1R458Tzh3guLamcFWgGhnpR60VEaCaQTQ/view?usp=sharing' target='_blank'> 
        ...
        <div className='w-full lg:w-1/2 lg:p-3'>
          <div className='flex justify-center lg:justify-end'>
            ...
            src={profilePic} alt="Jaideep Murthy" className='max-w-xs lg:max-w-md h-auto rounded-2xl  cursor-pointer  hover:scale-110' />
          </div>
        </div> */}
